"""
Docstring for modulo_7.args._funcoes

Entendendo o *args

- O *args é um parâmetro, como outro qualquer. Isso significa que você poderá
chamar de qualquer coisam desde que comece com asterisco.

Exemplo:

*xis

Mas a por convenção, utilizamos *args para definí-lo

Mas o que é o *args?

O parâmetro *args utilizado em uma função, coloca os valores extras informados como entrada
em uma tupla. Então já lembre-se que tuplas são imutáveis.
...
# O asterisco serve para que informemos ao Python que estamos passando como argumentos
# uma coleção de dadsos. Desta forma, ele saberá que precisará antes desempacotar estes dados.
